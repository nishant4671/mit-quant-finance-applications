...
def compile_latex_book():
    ...
    chapters = [
        ...
        {"title": "Applying Data Science and AI to Managing Biomedical Portfolios", "file": "L18_Biomedical_Portfolios.md"},
        {"title": "Volatility Modeling & Volatility Term Structure", "file": "L19_Volatility_Modeling.md"},
        {"title": "Building a Regulated Exchange for Trading on Events", "file": "L20_Event_Trading.md"},
